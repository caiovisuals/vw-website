    ...
    return (
        <div className="flex flex-col gap-4 px-6 py-6 md:py-10 md:px-12 lg:px-20">
            <div className="flex flex-row items-center justify-between">
                <h1 className="text-2xl lg:text-3xl vw-font">Monte seu Modelo</h1>
            ...
            <div>
                <div id="header" className="flex flex-row items-center justify-between gap-3">
                    ...
                    <button onClick={() => setIsModalOpen(true)} className="hidden lg:flex flex-row items-center justify-center gap-2 px-2.5 py-1 border-2 border-[var(--white-border)] hover:bg-[var(--white-background)]/15 rounded-2xl transition-normal cursor-pointer">
                    ...
                    <button onClick={() => setIsModalOpen(true)} className="flex lg:hidden flex-row items-center justify-center gap-2 px-2.5 py-1 border-2 border-[var(--white-border)] hover:bg-[var(--white-background)]/15 rounded-2xl transition-normal cursor-pointer">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            <path d="M10 5H3"/><path d="M12 19H3"/><path d="M14 3v4"/><path d="M16 17v4"/><path d="M21 12h-9"/><path d="M21 19h-5"/><path d="M21 5h-7"/><path d="M8 10v4"/><path d="M8 12H3"/>
                        </svg>
                        Filtros
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
                    {filteredCars.length === 0 ? (
                        <div className="col-span-full flex flex-col items-center justify-center py-16 text-center">
                            <h3 className="text-2xl">Sentimos muito.</h3>
                        ...
                        filteredCars.map(car => (
                            ...
                            >   
                                ...
                                <div className="absolute inset-0 w-full top-[28%] h-[42%] bg-[radial-gradient(circle,_#CCCECE_0%,_#AFAFAF_100%)] rounded-2xl transition-normal z-9" />
