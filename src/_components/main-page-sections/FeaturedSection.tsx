...
export default function FeaturedSection() {
    return (
        <section id="featured" className="flex flex-col items-center justify-center gap-16 py-6 md:py-10 lg:py-15 xl:py-20 px-6 md:px-10 lg:px-15 xl:px-20">
            <h2 className="text-center text-2xl sm:text-3xl md:text-4xl vw-font">Modelos em <span className="font-semibold">Destaque</span></h2>
            <div className="w-full flex flex-col-reverse lg:flex-row gap-12 lg:gap-16 md:max-w-7xl xl:max-w-8xl">
                <div className="w-full lg:w-[50%] flex flex-col gap-8">
                    <div>
                        <h3 className="text-xl sm:text-2xl md:text-3xl vw-font">Novo <span className="font-semibold">Tiguan R-Line</span></h3>
                        <p className="text-sm sm:text-base md:text-lg leading-tight">O SUV à altura da sua história</p>
                    </div>
